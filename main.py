...
class PygameGame(object):#PygameGame class from 15-112 Optional Lecture
    ...
    def __init__(self, width=600, height=400, fps=55, title="Hill Racer"):
        self.width = width
        self.height = height
        self.fps = fps
        self.title = title
...
class Game(PygameGame):
    ...
    def imagesInit(self):
        ...
        self.homeFinish=pygame.transform.scale(self.homeFinish,
                                (int(homeFinishW*.2), int(homeFinishH*.2)))
        self.gameScreen()
    ...
    def gameScreen(self):
        ...
        self.gameBackground = pygame.transform.scale(self.gameBackground,
                        (int(gameBackgroundW*3.2), int(gameBackgroundH*3.3)))
        ...
        self.invincibleCar=pygame.image.load('D:/game/truck2.jpg').convert_alpha()
    ...
    def drawHills(self,screen,numHills,pixelStep):
        ...
        for i in range(0,numHills):
            ...
            for j in range(0,int(hillSlices)+1):
                ...
                #draw polygon dependant upon four points to fill in green colour
            if (i!=0):
                hillStartY+=randomHeight
    ...
    def gameRedrawAll(self, screen):
        ...
        if self.invincible:
            ...
            if self.display:#display power up message
                ...
                over=font.render("TOP SPEED", True,(0,204,0))
